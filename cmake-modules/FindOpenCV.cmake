...
ELSE (${CMAKE_SYSTEM_NAME} STREQUAL Windows)
    ...
    IF (EXISTS /usr/lib/libopencv_core.so)
        ...
        SET(OPENCV_FOUND 1)
    ENDIF()
    IF (EXISTS /opt/local/lib/libopencv_core.dylib)
        SET (OPENCV_PATH /opt/local)
        SET(OPENCV_FOUND 1)
    ENDIF()
    IF (EXISTS /opt/lib/libopencv_core.dylib)
        SET (OPENCV_PATH /opt)
        SET(OPENCV_FOUND 1)
    ENDIF()
    IF (EXISTS /opt/local/lib/libopencv_core.so)
        SET (OPENCV_PATH /opt/local)
        SET(OPENCV_FOUND 1)
    ENDIF()
    IF (EXISTS /opt/lib/libopencv_core.so)
        SET (OPENCV_PATH /opt)
        SET(OPENCV_FOUND 1)
    ENDIF()
ENDIF()
